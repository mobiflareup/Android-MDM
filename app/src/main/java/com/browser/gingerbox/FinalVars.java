...
class FinalVars {
	...
	public static final String GOOGLE_SEARCH = "https://www.google.com/search?client=gingerbox&q=";
	public static final String BING_SEARCH = "www.bing.com/search?q=";
	public static final String DUCK_SEARCH = "https://duckduckgo.com/?t=gingerbox&q=";
	public static final String STARTPAGE_SEARCH = "https://startpage.com/do/metasearch.pl?language=english&cat=web&query=";
	public static final String HOMEPAGE = "https://www.yahoo.in";
	public static final String SETTINGS_INTENT = "android.intent.action.GINGERBOXSSETTINGS";
	public static final String INCOGNITO_INTENT = "android.intent.action.GINGERBOXINCOGNITO";
